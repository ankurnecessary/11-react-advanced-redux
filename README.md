...
59. We generally use @reduxjs/toolkit to implement redux with react.
60. We set up a redux store using configureStore() that we get from @reduxjs/toolkit.
